...
public class Land {
	...
	public Land(int width, MainCharacter mainCharacter) {
		...
		land1 = Resource.getResouceImage("data/newerland1.png");
		land2 = Resource.getResouceImage("data/newerland2.png");
		land3 = Resource.getResouceImage("data/newerland3.png");
