...
public class MainCharacter {
	...
	public MainCharacter() {
		...
		normalRunAnim.addFrame(Resource.getResouceImage("data/pinkmain1.png"));    
		normalRunAnim.addFrame(Resource.getResouceImage("data/pinkmain2.png"));
		jumping = Resource.getResouceImage("data/pinkmain3.png");
		downRunAnim = new Animation(90);
		downRunAnim.addFrame(Resource.getResouceImage("data/pink-main5.png"));
		downRunAnim.addFrame(Resource.getResouceImage("data/pinkmain6.png")); 
		deathImage = Resource.getResouceImage("data/pinkmain4.png");
